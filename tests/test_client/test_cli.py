...
def test_get_device_data(runner, access_token, app_and_ctx, reset_tiny_db, col_keys):
    ...
    user_id = "1"
    r = Mock()
    r.content = b'{\n  "device_data": [\n    {\n      "added": 2116580122, \n      "correctness_hash": "$2b$12$RzQ1VrzQVTA280pSAG4IyOXsZMplZNi67hp.XpF3ygPtTOW6EbXQG", \n      "data": "", \n      "device_id": 23, \n      "id": 6, \n      "num_data": 464064, \n      "tid": "gAAAAABcc5_jPEABPUBv4E-VWpazMSRF-5z6JDu6SMSDpLDUslW-hLdIdGeILVoE_7mSoHr-RZzU7KojN6MnI14DNen5Ojjgxw==", \n      "tid_bi": "19b0ac102511621a04272dc74ded56124ec487e4068e32f5274cbf04e7edbd1e"\n    }, \n    {\n      "added": 2244039737, \n      "correctness_hash": "$2b$12$jnpkAv9BVpWCLmSbytJ5hOPi0N55kk18OOZXX0cPFYlxL8vqmoJ2K", \n      "data": "", \n      "device_id": 23, \n      "id": 8, \n      "num_data": 466263, \n      "tid": "gAAAAABcc5_jcRdS6byYUE52rJ2Hv4rgvdf73XE6vh1_mColel-lRltMLJE9DolpZyuaE88B-44FO7CpEdEzwny_cR6VxdazKQ==", \n      "tid_bi": "8cca81860609303ae65ab3ee804a7c0dc2a783eed2c39ee27ee435cfc639825c"\n    }, \n    {\n      "added": 2328646538, \n      "correctness_hash": "$2b$12$piswhmlgjwIdfpyH6V7Z8eY2mim4u1bbGYXCzun07raC00fYO3LO.", \n      "data": "", \n      "device_id": 23, \n      "id": 4, \n      "num_data": 471232, \n      "tid": "gAAAAABcc5_jbq_4CrB8m_p4bjLj8Ivo9jrE02oTu_U4oKWzaZd8ghcUvrIsqrs2GZoIyQvD8JF3RqKpPZ-rogejv723gyo-2A==", \n      "tid_bi": "e7d546fbae9151090d66a378664eaf3450b6ee30a2f7df495343f514497b4b12"\n    }, \n    {\n      "added": 2893054513, \n      "correctness_hash": "$2b$12$FcBgR7vQmuhMUaPtQSGtWewJQzOHNYiu/y.SI2VXbe/oaAYaCTPuq", \n      "data": "", \n      "device_id": 23, \n      "id": 12, \n      "num_data": 468360, \n      "tid": "gAAAAABcc5_jp9eHuXaD1N2Srcyt51rOpfKlUNye-NTsj9c2K-ZKrpgoKYt59mYdTXrNzQPDwdDtXogFtBXRf_d21RzWNBBZ2Q==", \n      "tid_bi": "c4dedc6cfb2d4fa1d298ccb7a1b3309a93cd241e23b04e33b11deef1e8d1451d"\n    },\n  {\n      "added": -3371974092, \n      "correctness_hash": "$2b$12$FLzwDx6/a.ZrsXgGa1uU0OAMJUhfU9Ukq8HbxQ4DEwlqY8C/LDTsi", \n      "data": "", \n      "device_id": 23, \n      "id": 26, \n      "num_data": 1880673631, \n      "tid": "gAAAAABcaBdELr-gRHpHNXLk9LrbjtHsutZGkVTkwPcqVa5pV5k1ILXm985v3oQPHnvjaZaL3-ZesmREmvHCymTSJ_4yBaavxA==", \n      "tid_bi": "19b0ac102511621a04272dc74ded56124ec487e4068e32f5274cbf04e7edbd1e"\n    }], \n  "success": true\n}\n'
