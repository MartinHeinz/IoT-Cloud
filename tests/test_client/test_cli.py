...
def test_get_device_data(runner, access_token, app_and_ctx, reset_tiny_db, col_keys):
    ...
    cmd.fake_tuple_data = {'device_data': {'added': {'seed': 1, 'lower_bound': 2, 'upper_bound': 2, "type": "OPE"}, 'num_data': {'seed': 2, 'lower_bound': 2, 'upper_bound': 2, "type": "OPE"}, 'data': {'seed': 3, 'lower_bound': 2, 'upper_bound': 2, "type": "ABE"}, 'tid': {'lower_bound': 2, 'upper_bound': 2, "type": "Fernet"}}}
