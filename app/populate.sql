...
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (1, 1, 'device1', '1/23/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (2, 1, 'device1', '23/1/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (3, 1, 'device1', '23/server/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (4, 1, 'device1', 'server/23/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (5, 2, 'MartinHeinz', '1/23/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (6, 2, 'MartinHeinz', '23/1/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (7, 2, 'MartinHeinz', '1/server/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (8, 2, 'MartinHeinz', 'server/1/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (9, 3, 'device2', '2/45/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (10, 3, 'device2', '45/2/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (11, 3, 'device2', '45/server/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (12, 3, 'device2', 'server/45/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (13, 6, 'TestUser', '2/45/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (14, 6, 'TestUser', '45/2/+', 1);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (15, 6, 'TestUser', '2/server/+', 2);
INSERT INTO public.acl (id, mqtt_user_id, username, topic, acc) VALUES (16, 6, 'TestUser', 'server/2/+', 1);
...
SELECT pg_catalog.setval('public.device_id_seq', 40, false);
