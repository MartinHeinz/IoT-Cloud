...
def register_models():
    from app.models.models import Device, DeviceType, User, DeviceData, Action, Scene, AttrAuthUser, PublicKey, PrivateKey, Attribute, UserDevice  # noqa pylint: disable=unused-variable, cyclic-import
