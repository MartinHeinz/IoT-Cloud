...
def _stackapps_compliance_fix(session, site):
    ...
    def _token_response(resp):
        ...
        # data['expires_in'] = int(data['expires'])  # NOTE Left it here just in case, but it seems it's not necessary since we use scope `no_expiry`
    ...
    class StackApp(OAuthBackend):
        ...
        OAUTH_CONFIG = {
            ...
            'client_kwargs': {
                ...
                'api_key': os.getenv('STACKOVERFLOW_API_KEY', 'missing-api-key')
            },
